...
export default function Home(){
  ...
  const signup = async () => {
    ...
    const r = await fetch('/api/auth/signup', { method:'POST', headers:{'Content-Type':'application/json'}, body: JSON.stringify({ email, password: p1 }) });
    ...
    <Shell>
      <div className="card max-w-md mx-auto text-center">
        ...
        <div className="space-y-3">
          ...
          <button className="btn btn-primary w-full" onClick={signup}>Sign up</button>
